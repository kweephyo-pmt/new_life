      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-primary/90 to-primary/80 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <p className="text-xl text-white/90 leading-relaxed max-w-md">
            Join thousands of travelers planning smarter trips with personalized AI recommendations.
          </p>
          ...
          <div className="space-y-4 pt-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm">Get personalized travel suggestions</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h3 className="text-white font-semibold">Smart Itineraries</h3>
                <p className="text-white/80 text-sm">Plan trips with optimal timing</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h3 className="text-white font-semibold">Budget Tracking</h3>
                <p className="text-white/80 text-sm">Keep expenses under control</p>
              </div>
            </div>
          </div>
        </div>
